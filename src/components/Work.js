    ...
    <div className="Work pb-24">
        ...
        <h2 className="text-4xl font-bold my-4">Personal Work</h2>
          <div className="post-content">
                ...
                <p className="my-4"><a className="underline" href="https://main--tubular-boba-955693.netlify.app/" target="_blank" rel="noreferrer"><strong>National Park Info</strong></a> - This little page pulls some useful info from the National Park API.</p>
