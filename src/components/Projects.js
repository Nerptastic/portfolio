    ...
    <div className="Projects pb-24">
        <h2 className="text-4xl font-bold my-4">Past Work</h2>
          <div class="post-content">
              ...
              <p className="my-4"><a className="underline" href="https://www.neoship.org/" target="_blank" rel="noreferrer"><strong>SHIP Website</strong></a> - Developed a CMS site for Triad's "Design for Good" campaign.</p>
